  ...
  return knex('posts').truncate()
    .then(function () {
      return knex('posts').insert([
        ...
        { title: "post-9", contents: "She acts without expectation, succeeds without taking credit and doesn't think she is better than anyone else." },
        { title: "post-10", contents: "Act without doing; work without effort." },
        { title: "post-11", contents: "Do you have the patience to wait until your mud settles and the water is clear? Can you remain unmoving until the right action arises by itself?" },
        { title: "post-12", contents: "He who tries to shine dims his own light. He who defines himself can't know who he really is. He who clings to his work will do nothing that endures. Just do your job, then let go." }
      ]);
    });
};
